...
//        System.out.println("第一种生成代理类的方式: 通过 Proxy.newProxyInstance 方法 获取代理对象");
//        generateProxy1();
//
//
//    }
//
//    /**
//     * @Description 第一种生成代理类的方式：通过 Proxy.newProxyInstance 方法 获取代理对象
//     * @param
//     * @Return
//     */
//    public static void generateProxy1() {
//
//        // 1. 创建一个实例对象，这个对象是被代理的对象
//        Person person = new SoftwareEngineer();
//
//        // 2. 创建一个与代理类相关联的InvocationHandler,每一个代理类都有一个关联的 InvocationHandler，并将代理类引用传递进去
//        InvocationHandler Handler = new PersonInvocationHandler<>(person);
//
//        // 3. 创建一个代理对象，此代理对象的每个执行方法都会被替换执行Invocation接口中的invoke方法
...
//
//        // 4. 调用
//        personProxy.generateName("daiaoqi");
//
//    }
//
//    /**
...
//     */
////    public static void generateProxy2() throws Exception {
...
////        Class<?> proxyClass = Proxy.getProxyClass(Person.class.getClassLoader(), Person.class);        /** 代理类信息 */
...
////        stuProxy.base(stuProxy.getName(), "广州");        // 保存代理類
